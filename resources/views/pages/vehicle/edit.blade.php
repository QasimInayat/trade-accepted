            ...
            <div class="container">
                <div class="card">
                    <div class="card-header text-white" style="background-color:red;">
                        <a href="{{ route('vehicle.index') }}"><i style="font-size: 13px;" class="fa fa-chevron-left"></i>
                            <span><b>Back</b></span></a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    @foreach ($galleries as $gallery)
                                                        <div class="col-md-2 col-6">
                                                            <div style="border: 1px solid lightgrey; padding: 5px; text-align: center;"
                                                                class="mt-3">
                                                                <img src="{{ asset('upload/vehicle/' . $gallery->image) }}"
                                                                    style="height: 90px; width: 100%;" alt="">
                                                                <a href="{{ route('remove.gallery', $gallery->id) }}"
                                                                    class="remove_gallery"><small>Remove
                                                                        Image</small></a><br>
                                                                <input type="radio" name="is_main" class="mt-3"
                                                                    @if ($gallery->is_main == 1) checked @endif
                                                                    value="{{ $gallery->id }}">
                                                            </div>
                                                        </div>
                                                    @endforeach
                                            ...
                                            <div class="col-md-6 mt-4">
                                                <div class="form-floating">
                                                    <select name="country_id" required class="form-control custom-control"
                                                        id="country" onchange="print_state('state',this.selectedIndex);">
                                                    </select>
                                            ...
                                            <div class="col-md-6 mt-4">
                                                <div class="form-floating">
                                                    {!! Form::text('exterior_color', null, [
                                                        'class' => 'form-control',
                                                        'id' => 'floatingInput',
                                                        'placeholder' => 'Enter your exterior_color',
                                                        'aria-describedby' => 'floatingInputHelp',
                                                    ]) !!}
                                            ...
                                            <div class="col-md-6 mt-4">
                                                <div class="form-floating">
                                                    {!! Form::text('interior_color', null, [
                                                        'class' => 'form-control',
                                                        'id' => 'floatingInput',
                                                        'placeholder' => 'Enter your interior_color',
                                                        'aria-describedby' => 'floatingInputHelp',
                                                    ]) !!}
                                        ...
                                        <div class="col-md-12 mt-4">
                                            <div class="form-floating">
                                                {!! Form::select('status', ['0' => 'Deactive', '1' => 'Active'], null, [
                                                    'class' => 'form-control',
