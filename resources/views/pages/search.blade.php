                        ...
                        <div class="accordion wrapper1">
                            <form action="{{ route('search') }}" method="GET">
                                ...
                                <div class="accordion-item mt-4">
                                    <h5 class="mt-1" id="accordion-button-1" aria-expanded="true"><span
                                            class="accordion-title p-1 "><b>Search by Keyword</b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <div class="input-group ">
                                                <input autocomplete="off" name="title" value="{{ request('title') }}"
                                                    placeholder="Search Vehcile" class="vehicel-title form-control"
                                                    id="" type="search">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <h5 class="mt-1" id="accordion-button-2" aria-expanded="true"><span
                                            class="accordion-title p-1"><b> Country Location</b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <select name="country_id" class="form-control custom-control"
                                                value="{{ request('country_id') }}" id="country"
                                ...
                                <div class="accordion-item">
                                    <h5 class="mt-1" id="accordion-button-2" aria-expanded="true"><span
                                            class="accordion-title p-1"><b> City Location</b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <input type="text" class="form-control" value="{{ request('city_id') }}"
                                                name="city_id" placeholder="Search City">
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                            ...
                                            <select name="make_id" class="form-control custom-control" value="">
                                                ...
                                                @foreach ($makes as $make)
                                                    <option value="{{ $make->id }}"
                                                        @if (request('make_id') == $make->id) selected @endif>
                                                        {{ $make->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <input autocomplete="off" name="trim" value="{{ request('trim') }}"
                                                type="search" type="text" class="form-control" placeholder="Trim">
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="mt-1" id="accordion-button-5" aria-expanded="true"><span
                                            class="accordion-title p-1"><b> Transmission</b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <input autocomplete="off" name="transmission"
                                                value="{{ request('transmission') }}" type="search" type="text"
                                ...
                                <div class="accordion-item">
                                    <h5 class="mt-1" id="accordion-button-5" aria-expanded="true"><span
                                            class="accordion-title p-1"><b> Fuel</b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <input autocomplete="off" name="fuel" value="{{ request('fuel') }}"
                                                type="search" type="text" class="form-control" placeholder="Fuel">
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="mt-1" id="accordion-button-5" aria-expanded="true"><span
                                            class="accordion-title p-1"><b> Exterior Color</b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <input autocomplete="off" name="exterior_color"
                                                value="{{ request('exterior_color') }}" type="search" type="text"
                                                class="form-control" placeholder="Exterior color">
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="mt-1" id="accordion-button-5" aria-expanded="true"><span
                                            class="accordion-title p-1"><b> Interior Color</b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <input autocomplete="off" name="interior_color"
                                                value="{{ request('interior_color') }}" type="search" type="text"
                                                class="form-control" placeholder="Interior color">
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="mt-1" id="accordion-button-5" aria-expanded="true"><span
                                            class="accordion-title p-1"><b> Year</b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                ...
                                <div class="accordion-item">
                                    <h5 class="mt-1" id="accordion-button-5" aria-expanded="true"><span
                                            class="accordion-title p-1"><b>Mileage </b></span></h5>
                                    <div class="accordion-content p-2">
                                        <div class="input-group">
                                            <input type="text" class="form-control" value="{{ request('mileage') }}"
