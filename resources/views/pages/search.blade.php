                    ...
                    <div class="d-flex">
                        <div class="">
                          <div class="price-input">
                            ...
                            <div class="field">
                              <span>Max</span>
                              <input type="number" name="max" class="input-max" value="{{ request('max') ?? 10000000 }}">
                            </div>
                          </div>
                          <div class="slider">
                          ...
                          <div class="range-input">
                            <input type="range" name="min" class="range-min" min="0" max="10000000" value="{{ request('min') ?? 0 }}" step="100">
                            <input type="range" name="max"  class="range-max" min="0" max="10000000" value="{{ request('max') ?? 10000000 }}" step="100">
                          </div>
                        </div>
                      </div>
